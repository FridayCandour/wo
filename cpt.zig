...
const http = @import("http");
    ...
    fn getUpdates(offset: ?std.json.Token, allocator: *std.mem.Allocator) ?std.json.Token {
    ...
    fn sendMessage(chatId: i64, text: []const u8, allocator: *std.mem.Allocator) bool {
    ...
    fn handleIncomingMessages(updates: ?std.json.Token) void {
    ...
    pub fn pollUpdates() !void {
        ...
        while (true) {
            ...
            try std.time.sleep(std.time.Duration{.seconds = 1});
        }
    }
